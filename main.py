...
bot_names = ["LA FLAQUE", "LA BULLE", "LA NOUILLE",  "LA MOUCHE", "LE PIED-BOUCHE", "LE COUPE-JARRET", "LE SOFTEUR", "LE SUPPOSITOIRE", "LE STRING", "L'EGIRL", "LE PAGO",
             "LE NABOT", "LE FRÈRE", "LE NABUCHODONOSOR", "LE MALOTRU", "LA BÊTE"]
profile_pictures = ["./pics/flaque.png", "./pics/bulle.png", "./pics/nouille.png", "./pics/03mouche.jpeg", "./pics/08pied-bouche.png", "./pics/06coupe-jarret.jpeg", "./pics/09softeur.jpeg",
